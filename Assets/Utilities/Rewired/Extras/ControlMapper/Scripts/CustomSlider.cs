    ...
    public class CustomSlider : Slider, ICustomSelectable {
        ...
        public override Selectable FindSelectableOnRight() {
            if((navigation.mode & Navigation.Mode.Horizontal) != 0 || _autoNavRight) {
                return UISelectionUtility.FindNextSelectable(this, transform, Selectable.allSelectables.ToList(), Vector3.right);
            }
        ...
        public override Selectable FindSelectableOnUp() {
            if((navigation.mode & Navigation.Mode.Vertical) != 0 || _autoNavUp) {
                return UISelectionUtility.FindNextSelectable(this, transform, Selectable.allSelectables.ToList(), Vector3.up);
            }
        ...
        public override Selectable FindSelectableOnDown() {
            if((navigation.mode & Navigation.Mode.Vertical) != 0 || _autoNavDown) {
                return UISelectionUtility.FindNextSelectable(this, transform, Selectable.allSelectables.ToList(), Vector3.down);
            }
